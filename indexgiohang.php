            ...
            <div class="col-lg-8 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="javascript:history.back()">Mua Thêm Sản Phẩm Khác</a> 
                            ...
                            <table class="table">
                                ...
                                <?php
                                 ...
                                 ?>
                                            <tr>
                                                <td><?php echo $i ?></td>
                                                <td > <a href="chitietSP.php?maSP=<?php echo $data['maSP'] ?>"><img src="image/anhIphone/<?php echo $data['hinhanh']?> " style="width:100px;height:100px;"></a></td>
