    ...
    <div class="container ">
            ...
            <nav class="navbar navbar-expand-lg bg-info  border-bottom border-gray" color-on-scroll="500">
                <div class="container-fluid ml-5 ">
                     <h3 class="text-white">Nhà cung Cấp </h3> 
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item nav-link">
                                <a class=" text-white" href="themNCC.php"><button class="btn btn-danger">Thêm</button>  </a>
                            </li>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td>
                                                    <a href="xoaNCC.php?maNSX=<?php echo $value['maNSX'] ?>">
                                                    <label class="btn btn-danger">Xóa</label>
                                                    </a>
                                                </td>
                                                <td>
                                                   <a href="capnhatNCC.php?maNSX=<?php echo $value['maNSX'] ?>">
