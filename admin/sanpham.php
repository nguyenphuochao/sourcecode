    ...
    <div class="container ">
            ...
            <nav class="navbar navbar-expand-lg bg-info  border-bottom border-gray" color-on-scroll="500">
                <div class="container-fluid ml-5 ">
                     <h3 class="text-white">Sản Phẩm</h3> 
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item nav-link">
                                <a class=" text-white" href="themSanPham.php"><button class="btn btn-danger">Thêm</button>  </a>
                            </li>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr >
                                                ...
                                                <td><img src="../image/anhIphone/<?php echo $value['hinhanh']?> " style="width:100px;height:100px;"></td>
                                                ...
                                                <td>
                                                    <a href="xoasp.php?maSP=<?php echo $value['maSP'] ?>"> <label class="btn btn-danger">Xóa</label>
                                                    </a>
                                                </td>
                                                <td>
                                                   <a href="capnhatSuaSP.php?maSP=<?php echo $value['maSP'] ?>">
                                                    <label class="btn btn-primary">cập nhật</label></a>
                                                </td>
                                            <?php 
                                            }
                                            ?>
